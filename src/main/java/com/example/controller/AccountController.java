...
public class AccountController {
    ...
    @Autowired
    public AccountController(AccountService accountService, ContactService contactService, BalanceLoader balanceLoader, PasswordEncoder bCryptPasswordEncoder) {
